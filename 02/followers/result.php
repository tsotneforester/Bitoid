  ...
  <div class="resultbox">
    ...
    <div class="result">
      ...
      if (isset($_POST["submit"])) {
        ...
        $followersCheck = array_key_exists("followers", $userInfo);



        if ($followersCheck === true) {
          //--------------------check whether user exists--------------------
          $followersCount = $userInfo["followers"];
          $pageNumber = ceil($userInfo["followers"] / 20) + 1;
          //----------------------------------------------------------------
          if ($followersCount > 0) {
      ?>
            ...
            <table>
              <tr id="header">
                ...
                <th>Photo</th>
                <th style="border-top-right-radius: 12px;">USER</th>
              </tr>';
              ...
              $result = parseJson("https://api.github.com/users/$userName/followers?per_page=20&page=1");
