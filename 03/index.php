   ...
   <body>
     ...
     <?php
      if (isset($_POST["submit"])) {
        ...
        $sql = "SELECT * FROM heroes WHERE name='$caracter_name'";
        ...
        if (mysqli_num_rows($result) >= 1) {
          ...
          if ($data['data']['total'] > 0) {
            ...
            $sql = "INSERT INTO `heroes` VALUES ('0','$fl_name', '$image_format', '$comment' )";
            mysqli_query($conn, $sql);



            $sqlView = "SELECT * FROM heroes WHERE name='$caracter_name'";
